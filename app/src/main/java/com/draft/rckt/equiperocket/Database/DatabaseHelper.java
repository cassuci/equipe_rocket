...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_RECEITAS =
            ...
            " CREATE TABLE " + ReceitaEntry.TABLE_NAME + " (" +
                    ...
                    ReceitaEntry.COLUMN_NAME_USER_ID + TEXT_TYPE + " NOT NULL, " +
                    ReceitaEntry.COLUMN_NAME_TITLE + TEXT_TYPE  + " , " +
                    ReceitaEntry.COLUMN_NAME_CONTENT + TEXT_TYPE  + " , " +
                    ReceitaEntry.COLUMN_NAME_VALUE + " DOUBLE NOT NULL, " +
                    ReceitaEntry.COLUMN_NAME_TYPE + TEXT_TYPE  + " , " +
                   // ReceitaEntry.COLUMN_NAME_DATE + DATE_TYPE + " DEFAULT NOW(), " +
    ...
    private static final String SQL_CREATE_GASTOS =
            ...
            " CREATE TABLE " + GastoEntry.TABLE_NAME + " (" +
                    ...
                    GastoEntry.COLUMN_NAME_USER_ID + TEXT_TYPE + " NOT NULL, " +
                    GastoEntry.COLUMN_NAME_TITLE + TEXT_TYPE  + " , " +
                    GastoEntry.COLUMN_NAME_CONTENT + TEXT_TYPE  + " , " +
                    GastoEntry.COLUMN_NAME_VALUE + " DOUBLE NOT NULL, " +
                    GastoEntry.COLUMN_NAME_TYPE + TEXT_TYPE  + " , " +
                    // ReceitaEntry.COLUMN_NAME_DATE + DATE_TYPE + " DEFAULT NOW(), " +
